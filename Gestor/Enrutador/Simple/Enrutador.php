...
class Enrutador implements IEnrutador
{
     ...
     *  @param array  $disponibles Array con los elementos disponibles y accesibles
     ...
     *
     *  @throw Exception Si no existe ningún archivo que coincida con $principal o $inexistente
     */
